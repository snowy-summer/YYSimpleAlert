...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/snowy-summer/YYSimpleAlert'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'snowy-summer' => '118453865+snowy-summer@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/snowy-summer/YYSimpleAlert.git', :tag => s.version.to_s }
